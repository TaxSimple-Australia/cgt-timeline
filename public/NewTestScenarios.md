...
When a property transitions from main residence to rental (move_out event followed by rent_start), the `market_value_at_first_income` field captures the revised cost base at that point in time. This is critical for:
...
The `market_value_at_first_income` should be the sum of:
- Purchase price
...
This value is user-editable but can be auto-calculated from the cost base items recorded before the move_out date.
...
- **Rented**: 1,873 days (5 years, 1.5 months)
  ...
  "properties": [
    {
      ...
      "property_history": [
        ...
        },
        {
          "date": "2019-06-30",
          "event": "move_out",
          "market_value_at_first_income": 919800
        },
        {
          "date": "2019-06-30",
          "event": "rent_start"
...
- **Rent Start Date**: 28 February 2014 (same day as move out)
- **Sale Date**: 1 June 2024
- **Purchase Price**: $450,000
- **Market Value at First Rental**: $480,000 (First use to produce income rule applies)
- **Sale Price**: $1,250,000
- **Total Ownership Days**: 4,476 days (from rent start to sale: 3,747 days)
...
| 28 Feb 2014 | Rent Start | Tenant moves in (same day as move out). Market value: $480,000 |
...
Step 1: Apply First Use to Produce Income Rule (s118.192)
  ...
  - Deemed acquisition date: 28 February 2014
  - Deemed cost base: $480,000 (market value at first rental)

Step 2: Calculate Rental Period
  Rent Start: 28 February 2014
  Sale Date: 1 June 2024
  Total Rental Period = 3,747 days = 10.26 years

  ✗ Rental period EXCEEDS 6 years by 3.26 years (1,096 days)

Step 3: Calculate Ownership Period (from deemed acquisition)
  Deemed Acquisition: 28 February 2014
  Sale Date: 1 June 2024
  Total Ownership = 3,747 days

Step 4: Calculate Non-Main-Residence Days
  Total rental days: 3,747
  Six-year exemption: 2,192 days (6 years)
  Non-main-residence days: 3,747 - 2,192 = 1,555 days

  Note: Using the period from 28 February 2020 (end of 6-year rule)
  to 1 June 2024 = 1,555 days as non-main-residence period
...
Step 6: Apply Partial Main Residence Exemption
  ...
  Taxable Proportion = 1,555 / 3,747 = 41.50%

  Taxable Capital Gain = $735,950 × 41.50% = $305,419

Step 7: Apply 50% CGT Discount
  Held > 12 months: ✓
  Discounted Gain = $305,419 × 50% = $152,710

RESULT: NET CAPITAL GAIN = $152,710
```
  ...
  "properties": [
    {
      ...
      "property_history": [
        ...
        },
        {
          "date": "2014-02-28",
          "event": "move_out",
          "market_value_at_first_income": 480000
        },
        {
          "date": "2014-02-28",
          "event": "rent_start"
...
- **Move In Date**: 10 April 2019 (same day as rent end)
...
| 01 May 2012 | Move In | Established as main residence (same day as purchase) |
...
| 01 Feb 2024 | Move In | Established as new main residence (same day as purchase) |
  ...
  "properties": [
    {
      ...
      "property_history": [
        ...
        },
        {
          "date": "2024-02-01",
          "event": "move_out",
          "market_value_at_first_income": 436900
        },
        {
          "date": "2024-07-15",
          "event": "sale",
...
| 3. Six-Year Rule (Exceeded) | s118.145 + s118.192 | 10+ years | 58.50% | $152,710 |

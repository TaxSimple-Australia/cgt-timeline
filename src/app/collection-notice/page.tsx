            ...
            <div className="bg-gray-100/50 dark:bg-slate-800/50 backdrop-blur-sm border border-cyan-500/20 rounded-2xl p-8 shadow-xl relative overflow-hidden">
              ...
              <div className="relative">
                <div className="space-y-6 text-gray-600 dark:text-slate-300">
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">1. Who is collecting your information?</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">2. Why are we collecting this information?</h3>
                    ...
                    <ul className="space-y-3 pl-6">
                      ...
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Automated Processing:</strong> We use automated algorithms to categorize your assets and calculate discounts. You can review or manually override these results at any time.</span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">3. What happens if you don't provide it?</h3>
                    <p className="leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">4. Disclosure to Third Parties</h3>
                    <p className="mb-3 leading-relaxed">We do not sell your personal data. We may disclose your information to:</p>
                    <ul className="space-y-3 pl-6">
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">The ATO:</strong> Only if you explicitly choose to use our "Direct Lodgement" or "Data Matching" features.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Authorized Professionals:</strong> Your nominated accountant or tax agent (only with your specific permission).</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Service Providers:</strong> We use secure cloud hosting services located in Australia / USA / Europe. Where data is stored overseas, we take steps to ensure it is handled in accordance with Australian privacy standards.</span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">5. Access, Correction, and Complaints</h3>

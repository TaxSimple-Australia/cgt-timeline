        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <motion.div
              ...
              className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-xl p-8"
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-slate-50/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition"
                      placeholder="John"
                    />
                  </div>
                  <div>
                ...
                {/* Agency/Organization */}
                <div>
                  <label htmlFor="organization" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-2">
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <MapPin className="w-6 h-6 text-slate-500 dark:text-slate-400 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-slate-900 dark:text-white font-semibold mb-2">Physical Address</h3>
              ...
              {/* Phone Numbers */}
              <div className="flex items-start gap-4">
                <Phone className="w-6 h-6 text-slate-500 dark:text-slate-400 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-slate-900 dark:text-white font-semibold mb-2">Phone</h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm">
              ...
              {/* Email */}
              <div className="flex items-start gap-4">
                <Mail className="w-6 h-6 text-slate-500 dark:text-slate-400 flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-slate-900 dark:text-white font-semibold mb-2">Email</h3>
                  <a
                    href="mailto:info@cgtbrain.com.au"
                    className="text-slate-600 dark:text-slate-300 text-sm hover:text-cyan-400 transition"
                  >
              ...
              {/* Additional Info */}
              <div className="p-6 bg-slate-50/50 dark:bg-slate-800/30 border border-slate-200 dark:border-slate-700 rounded-lg">
          ...
          <motion.div
            ...
            className="w-full h-[400px] md:h-[500px] rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700"
          >
            <iframe

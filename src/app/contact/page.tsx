          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            >
              ...
              <div className="flex items-start gap-4">
                <MapPin className="w-6 h-6 text-slate-600 dark:text-slate-400 flex-shrink-0 mt-1" />
                <div>
              ...
              {/* Phone Numbers */}
              <div className="flex items-start gap-4">
                <Phone className="w-6 h-6 text-slate-600 dark:text-slate-400 flex-shrink-0 mt-1" />
                <div>
              ...
              {/* Email */}
              <div className="flex items-start gap-4">
                <Mail className="w-6 h-6 text-slate-600 dark:text-slate-400 flex-shrink-0 mt-1" />
                <div>

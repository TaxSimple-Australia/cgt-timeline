  ...
  if (shareId) {
    return (
      <div className="fixed inset-0 z-[100] bg-white dark:bg-slate-950 flex items-center justify-center">
        <div className="bg-gray-50 dark:bg-slate-900 rounded-lg p-8 max-w-sm text-center shadow-xl border border-gray-200 dark:border-slate-800">
          <div className="animate-spin h-10 w-10 border-4 border-cyan-500 border-t-transparent rounded-full mx-auto mb-4" />
          <p className="text-lg font-medium text-gray-900 dark:text-white">Loading shared timeline...</p>
          <p className="text-sm text-gray-500 dark:text-slate-400 mt-2">Please wait while we redirect you</p>
        </div>
      </div>
    );
  }

...
function LandingContent() {
  ...
  if (shareId) {
    return (
      <div className="fixed inset-0 z-[100] bg-slate-200 dark:bg-slate-950 flex items-center justify-center">
        <div className="bg-slate-100 dark:bg-slate-900 rounded-lg p-8 max-w-sm text-center shadow-xl border border-slate-400 dark:border-slate-800">

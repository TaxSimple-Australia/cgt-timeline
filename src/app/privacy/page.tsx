      ...
      <main className="relative z-10 pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.section
            ...
            className="mb-8"
          >
            <div className="bg-gray-100/50 dark:bg-slate-800/50 backdrop-blur-sm border border-cyan-500/20 rounded-2xl p-8 shadow-xl relative overflow-hidden">
              ...
              <div className="relative">
                <div className="space-y-6 text-gray-600 dark:text-slate-300">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">2. The Types of Data We Collect</h3>
                    <p className="mb-3 leading-relaxed">To provide accurate CGT assessments, we may collect the following:</p>
                    <ul className="space-y-3 pl-6">
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Identity Data:</strong> Name, email address, and contact details when you create an account.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Financial & Asset Data:</strong> Purchase/sale dates, cost base amounts, asset types (e.g., type of real estate property/dwelling), and residency status.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Usage Data:</strong> IP addresses, device type, and how you interact with the tool.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Sensitive Information:</strong> We generally do not require your Tax File Number (TFN). <span className="font-semibold text-orange-400">Users are advised not to enter TFNs or bank account numbers into the App.</span></span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">3. How We Use Your Data</h3>
                    <p className="mb-3 leading-relaxed">We use your information strictly for the following purposes:</p>
                    <ul className="space-y-3 pl-6">
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">CGT Assessment:</strong> To process your inputs and determine potential tax exemptions.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">App Improvement:</strong> To analyze de-identified, aggregated data to improve our calculation logic.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Compliance:</strong> To meet our legal and regulatory obligations within Australia.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Support:</strong> To respond to your inquiries or technical issues.</span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">4. Data Storage and Sovereignty</h3>
                    <ul className="space-y-3 pl-6">
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Local vs. Cloud Storage:</strong> CGT BRAIN data is uploaded to a local host and cloud server for record storage purposes.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Australian Hosting:</strong> Where possible, we strive to host data on servers located within Australia to ensure it remains subject to Australian privacy protections.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Retention:</strong> We retain your data only as long as necessary to provide the service or as required by law.</span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">5. Disclosure of Information</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">6. Data Security Measures</h3>
                    <p className="mb-3 leading-relaxed">We implement industry-standard security to protect your financial inputs, including:</p>
                    <ul className="space-y-3 pl-6">
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Encryption:</strong> Data is encrypted both in transit (SSL/TLS) and at rest.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Access Control:</strong> Strict internal policies to ensure only authorized personnel can access system back-ends.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-cyan-400 mt-1.5">•</span>
                        <span><strong className="text-gray-900 dark:text-white">Anonymization:</strong> Financial data used for analytics is stripped of all personally identifiable information.</span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">7. Your Rights (Access and Correction)</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">8. Changes to this Policy</h3>
                    <p className="leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">9. Contact Us / Complaints</h3>
                    <p className="leading-relaxed">
          ...
          >
            <Link
              href="/terms"
              className="group flex items-center gap-2 px-6 py-3 bg-gray-100/50 dark:bg-slate-800/50 backdrop-blur-sm border border-cyan-500/30 hover:border-cyan-500/50 rounded-full text-gray-600 dark:text-slate-300 hover:text-gray-900 dark:hover:text-white transition-all duration-300 hover:scale-105"
            >

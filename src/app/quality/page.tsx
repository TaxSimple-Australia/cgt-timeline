      ...
      <main className="relative z-10 pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.section
            ...
            className="mb-8"
          >
            <div className="bg-slate-200/80 dark:bg-slate-800/50 backdrop-blur-sm border border-purple-500/20 rounded-2xl p-8 shadow-xl relative overflow-hidden">
          ...
          >
            <Link
              href="/data-retention"
              className="group flex items-center gap-2 px-6 py-3 bg-slate-200/80 dark:bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 hover:border-purple-500/50 rounded-full text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all duration-300 hover:scale-105"
            >

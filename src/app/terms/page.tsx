      ...
      <main className="relative z-10 pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.section
            ...
            className="mb-8"
          >
            <div className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-8 shadow-xl relative overflow-hidden">
              ...
              <div className="relative">
                <div className="space-y-6 text-slate-600 dark:text-slate-300">
                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">1. Introduction and Scope</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">3. User Responsibilities and Inputs</h3>
                    <ul className="space-y-3 pl-6">
                      <li className="flex items-start gap-3">
                        <span className="text-blue-400 mt-1.5">•</span>
                        <span><strong className="text-slate-900 dark:text-white">Data Accuracy:</strong> The accuracy of any assessment regarding CGT exemptions is strictly dependent on the data you provide. You warrant that all information entered is true and correct.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-blue-400 mt-1.5">•</span>
                        <span><strong className="text-slate-900 dark:text-white">Record Keeping:</strong> You acknowledge that under Australian law, you are responsible for maintaining primary records (receipts, contracts) to support your tax positions for at least 5 years.</span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">4. Australian Consumer Law (ACL)</h3>
                    <p className="mb-3 leading-relaxed">
                      <strong className="text-slate-900 dark:text-white">Consumer Guarantees:</strong> Our services come with guarantees that cannot be excluded under the Australian Consumer Law. Nothing in these Terms excludes, restricts, or modifies any right or remedy you have under the Competition and Consumer Act 2010 (Cth).
                    </p>
                    <p className="mb-3 leading-relaxed"><strong className="text-slate-900 dark:text-white">Limitation of Liability:</strong> To the maximum extent permitted by law, CGT BRAIN is not liable for:</p>
                    <ul className="space-y-3 pl-6">
                      <li className="flex items-start gap-3">
                        <span className="text-blue-400 mt-1.5">•</span>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">5. Intellectual Property</h3>
                    <p className="leading-relaxed">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">6. Privacy and Security</h3>
                    ...
                    <ul className="space-y-3 pl-6">
                      <li className="flex items-start gap-3">
                        <span className="text-blue-400 mt-1.5">•</span>
                        <span><strong className="text-slate-900 dark:text-white">Data Handling:</strong> We use industry-standard encryption to protect your financial data.</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-blue-400 mt-1.5">•</span>
                        <span><strong className="text-slate-900 dark:text-white">Anonymity:</strong> The app can be used without linking a real identity.</span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">7. Updates to Tax Logic</h3>
                    <p className="leading-relaxed">
          ...
          >
            <Link
              href="/privacy"
              className="group flex items-center gap-2 px-6 py-3 bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm border border-blue-500/30 hover:border-blue-500/50 rounded-full text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all duration-300 hover:scale-105"
            >

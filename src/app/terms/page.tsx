              ...
              <div className="relative">
                <div className="space-y-6 text-slate-300">
                  ...
                  <div>
                    ...
                    <p className="leading-relaxed">
                      All algorithms, logic flows, "checklists," and interface designs used to determine CGT status are the exclusive intellectual property of TAX SIMPLE AUSTRALIA. You are granted a limited, non-transferable license for personal or internal business use only.
                    </p>
                  </div>
                </div>
              </div>

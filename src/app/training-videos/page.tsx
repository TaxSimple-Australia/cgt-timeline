        ...
        <div className="max-w-7xl mx-auto">
          {filteredVideos.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h3 className="text-xl font-semibold text-slate-600 dark:text-slate-400 mb-2">No videos found</h3>
              <p className="text-slate-600 dark:text-slate-500">Try adjusting your search or filter</p>
            </div>
          ) : (
                  ...
                  <div className={cn(
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <ChevronRight className="w-4 h-4 text-slate-600 dark:text-slate-500 group-hover:text-cyan-400 transition-colors" />
                      </div>
                    </div>
                  </div>
                </motion.div>

    ...
    <div className="relative w-full h-full p-8 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-2xl">
        ...
        >
          ...
          <div className="text-[10px] text-slate-600 dark:text-slate-400">Melbourne, VIC</div>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -bottom-16 bg-slate-100/90 dark:bg-slate-800/90 backdrop-blur-sm border border-slate-400/10 dark:border-white/10 rounded-lg px-3 py-2 min-w-[80px] text-center"
                >
                  <div className="text-[10px] text-slate-600 dark:text-slate-400 mb-0.5">{event.date}</div>
                ...
                {/* Connector Line */}
                <div className="absolute top-full w-px h-4 bg-gradient-to-b from-slate-200/20 to-transparent" />
              </motion.div>
            );
          })}
        </div>
        ...
        >
          <div className="absolute inset-0 flex items-center justify-center gap-2">
            ...
            <div className="w-px h-3 bg-slate-200/30" />
      ...
      >
        <div className="text-[10px] text-slate-600 dark:text-slate-400 mb-0.5">Capital Gain</div>

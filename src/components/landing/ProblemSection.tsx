...
export default function ProblemSection() {
  ...
  return (
    <section className="relative py-24 px-4 bg-gradient-to-b from-slate-200 via-slate-200/98 to-slate-200 dark:from-slate-900 dark:via-slate-900/98 dark:to-slate-900">
      {/* Background pattern */}

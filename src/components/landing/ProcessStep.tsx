  ...
  return (
    <div className="relative flex flex-col items-center text-center">
      ...
      >
        ...
        {/* Step number badge */}
        <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-gray-100 dark:bg-slate-800 border-2 border-cyan-500 flex items-center justify-center">
      ...
      >
        ...
        <p className="text-gray-500 dark:text-slate-400 max-w-xs mx-auto leading-relaxed">{description}</p>
      </motion.div>
    </div>
  );
}

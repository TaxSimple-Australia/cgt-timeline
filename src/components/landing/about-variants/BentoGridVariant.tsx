...
const tile = 'bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 hover:border-cyan-500/30 transition-all';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-5">AI-Powered Intelligence</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-5">Expert Human Oversight</h3>
            <ul className="space-y-3 text-slate-300 text-sm">
              {[
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-4">AI + Human Partnership</h3>
            <p className="text-slate-400 max-w-5xl mx-auto leading-relaxed">

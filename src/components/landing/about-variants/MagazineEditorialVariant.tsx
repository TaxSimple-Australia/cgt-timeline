    ...
    <section className="relative py-24 px-4 bg-slate-200 dark:bg-slate-950">
      <div className="max-w-6xl mx-auto">
        ...
        {[
          ...
          >
            <span className="absolute -top-8 left-0 text-[120px] font-thin text-slate-200/60 dark:text-slate-800/60 leading-none select-none pointer-events-none">
              {item.num}
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-3">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white">AI-Powered Intelligence</h3>
              </div>
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Expert Human Oversight</h3>
              </div>
              <ul className="space-y-3 text-slate-600 dark:text-slate-300">
                {[
          ...
          <div className="space-y-20">
            {[
              ...
              <div key={step.num} className="relative">
                <span className="absolute -top-6 right-0 text-[100px] font-thin text-slate-200/50 dark:text-slate-800/50 leading-none select-none pointer-events-none hidden md:block">
                  {step.num}
                </span>

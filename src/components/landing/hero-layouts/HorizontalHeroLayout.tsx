    ...
    <div className="relative w-full h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 w-full flex items-center">
        ...
        >
          ...
          <motion.p
            variants={fadeInUp}
            className="text-slate-600 dark:text-slate-400 text-sm mt-6"
          >
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div>
                <p className="text-[10px] md:text-xs text-slate-600 dark:text-slate-400">Welcome back</p>
          ...
          >
            <div className="relative overflow-hidden w-full max-h-[400px] md:max-h-[450px] lg:max-h-[500px] xl:max-h-[550px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-200/20 dark:from-slate-900/20 via-transparent to-transparent" />
            </div>

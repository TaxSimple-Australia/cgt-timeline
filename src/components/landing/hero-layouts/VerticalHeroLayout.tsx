  ...
  return (
    <>
      ...
      <div className="absolute inset-0">
        {/* Main grid */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(6,182,212,0.15)_1px,transparent_1px),linear-gradient(to_bottom,rgba(6,182,212,0.15)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,#000_70%,transparent_100%)] opacity-0 dark:opacity-100" />

        {/* Grid glow intersections */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_0%_0%,rgba(6,182,212,0.3)_0.5px,transparent_1px),radial-gradient(circle_at_4rem_0%,rgba(6,182,212,0.3)_0.5px,transparent_1px),radial-gradient(circle_at_0%_4rem,rgba(6,182,212,0.3)_0.5px,transparent_1px),radial-gradient(circle_at_4rem_4rem,rgba(6,182,212,0.3)_0.5px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,#000_70%,transparent_100%)] animate-grid-glow opacity-0 dark:opacity-100" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          <div className="h-px w-12 bg-gradient-to-r from-transparent to-slate-200 dark:to-slate-600" />
          ...
          <div className="h-px w-12 bg-gradient-to-l from-transparent to-slate-200 dark:to-slate-600" />
        </motion.div>
        ...
        <motion.p
          ...
          className="text-base md:text-lg lg:text-xl text-slate-600 dark:text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed"
        >
        ...
        >
          ...
          <Link href="#how-it-works">
            <Button variant="outline" size="lg" className="border-slate-400 dark:border-slate-600 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white px-8 py-6 text-lg">
              See How It Works
            </Button>
          </Link>
        </motion.div>
        ...
        >
          <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-slate-200/50 to-slate-200/50 dark:from-slate-800/50 dark:to-slate-900/50 backdrop-blur-sm border border-cyan-500/70 shadow-2xl shadow-cyan-500/80 p-2">
            ...
            {/* Inner container */}
            <div className="relative bg-slate-100/90 dark:bg-slate-900/90 rounded-xl overflow-hidden">
              {/* Timeline Screenshot */}
      ...
      >
        <div className="bg-slate-100/60 dark:bg-slate-800/40 backdrop-blur-xl border border-cyan-500/30 rounded-2xl p-4 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 transition-shadow">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-lg">
              <Sparkles className="w-5 h-5 text-cyan-400" />
            </div>
            <div>
              <p className="text-slate-900 dark:text-white font-semibold text-sm">AI-Powered Analysis</p>
      ...
      >
        <div className="bg-slate-100/60 dark:bg-slate-800/40 backdrop-blur-xl border border-purple-500/30 rounded-2xl p-4 shadow-lg shadow-purple-500/20 hover:shadow-purple-500/40 transition-shadow">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg">
              <FileText className="w-5 h-5 text-purple-400" />
            </div>
            <div>
              <p className="text-slate-900 dark:text-white font-semibold text-sm">PDF Export</p>

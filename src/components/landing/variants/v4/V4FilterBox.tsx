...
export default function V4FilterBox() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50/90 dark:from-slate-900/90 to-gray-100/90 dark:to-slate-800/90 backdrop-blur-xl border border-gray-300/50 dark:border-slate-700/50 rounded-2xl p-6 shadow-2xl shadow-black/20">
      {/* Tabs */}
      <div className="flex gap-2 mb-6">
        <button
          ...
          className={`flex-1 px-4 py-2.5 rounded-xl font-medium transition-all ${
            activeTab === 'single'
              ? 'bg-gray-100 dark:bg-slate-800 text-gray-900 dark:text-white shadow-lg'
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
        ...
        <div className="space-y-2">
          <label className="text-xs text-gray-500 dark:text-slate-400 font-medium uppercase tracking-wider">
            Property Type
          </label>
          <select className="w-full px-4 py-3 bg-gray-100/70 dark:bg-slate-800/70 border border-gray-300/50 dark:border-slate-700/50 rounded-xl text-gray-900 dark:text-white text-sm focus:outline-none focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20 transition-all">

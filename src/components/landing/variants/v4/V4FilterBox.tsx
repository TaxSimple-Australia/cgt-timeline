...
export default function V4FilterBox() {
  ...
  return (
    <div className="bg-gradient-to-br from-white/90 dark:from-slate-900/90 to-slate-50/90 dark:to-slate-800/90 backdrop-blur-xl border border-slate-200/50 dark:border-slate-700/50 rounded-2xl p-6 shadow-2xl shadow-black/20">
      {/* Tabs */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
        ...
        <div className="space-y-2">
          ...
          <select className="w-full px-4 py-3 bg-slate-100/70 dark:bg-slate-800/70 border border-slate-200/50 dark:border-slate-700/50 rounded-xl text-slate-900 dark:text-white text-sm focus:outline-none focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20 transition-all">

...
export default function DetailedReportModal({
  ...
  // Group issues by property address (for Classic View)
  const groupIssuesByProperty = () => {
    const issuesByProperty: Record<string, any[]> = {};
    const generalIssues: any[] = [];
            ...
            {activeTab === 'classic' && (
              <div className="space-y-6">
                ...
                {hasBreakdown && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      {breakdown && (
                        <CGTBreakdownChart data={breakdown} delay={0.3} />
                      )}

                      {/* Tax Breakdown Pie Chart */}
                      {breakdown && (
                        <TaxBreakdownPieChart data={breakdown} delay={0.4} />
                      )}
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                  ...
                  {/* Right Column: Quick Stats & Financial Summary */}
                  <div className="lg:col-span-5 space-y-6">
                    ...
                    {hasBreakdown && breakdown && (
                      ...
                      >
                        ...
                        <div className="space-y-3">
                          {breakdown.capital_gain !== undefined && (
                          ...
                          {breakdown.tax_payable !== undefined && (
